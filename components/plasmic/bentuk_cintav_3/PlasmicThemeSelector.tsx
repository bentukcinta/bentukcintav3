...
import Theme2 from "../../Theme2"; // plasmic-import: YRvcjInRnoeK/component
  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        <Theme2
          data-plasmic-name={"theme2"}
          data-plasmic-override={overrides.theme2}
          className={classNames("__wab_instance", sty.theme2)}
          slug={(() => {
            try {
              return $props.selectorSlug;
            } catch (e) {
...
export const PlasmicThemeSelector = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    theme2: makeNodeComponent("theme2"),
